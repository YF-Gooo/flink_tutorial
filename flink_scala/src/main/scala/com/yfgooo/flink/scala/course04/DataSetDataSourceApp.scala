...
//    readRecursiveFiles(env)
  ...
  def readCompressionFiles(env:ExecutionEnvironment): Unit = {
    val filePath = "/Users/rocky/IdeaProjects/yfgooo-workspace/data/04/compression"
    env.readTextFile(filePath).print()
  }

  def readRecursiveFiles(env:ExecutionEnvironment): Unit = {
    val filePath = "/Users/rocky/IdeaProjects/yfgooo-workspace/data/04/nested"
    env.readTextFile(filePath).print()
    println("~~~~~~~华丽的分割线~~~~~~~~")
  ...
  def csvFile(env:ExecutionEnvironment): Unit = {
    ...
    val filePath = "file:///Users/rocky/IdeaProjects/yfgooo-workspace/data/04/people.csv"
...
//    val filePath = "file:///Users/rocky/IdeaProjects/yfgooo-workspace/data/04/hello.txt"
//    env.readTextFile(filePath).print()

      val filePath = "file:///Users/rocky/IdeaProjects/yfgooo-workspace/data/04/inputs"
      env.readTextFile(filePath).print()
  }
